...
The the code above, we are storing a subset of "data" into a new object "data1". Here, we have specified R to only add in data if the "treatment" column matches the string "pH 6" which represents our CR pH 6 treatment.
