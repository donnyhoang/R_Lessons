...
```
## Goals:
Goal 1: Familiarize yourself with basic R commands. We will achieve this goal by graphing our pH data.

Goal 2: Understand how pH changes over time in our CR communitties.
