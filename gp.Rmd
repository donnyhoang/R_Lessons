...
Thus far, I have provided code for you to follow along with. The goal if your you to become comfortable working in R on your own. We will begin with using sample data from phyloseq, and will work within phyloseq to make things easier.
...
1. How does overall diversity compare between sample types? Do they match your expectations or what you've heard about for those environments?

2. Take a look at the richness and evenness of Freshwater (creek) samples. What can you conclude from just the richness, and just the evenness? Taken together, what does that suggest about the commonity composition of these Freshwater (creek) samples?
...
1. Where are most Streptomyces found? What other sample types are they "abundant" in? Does that make sense with what you know of Streptomyces?
...
1. Compare the otu_table of the GlobalPatterns object and otu_table of the new gp object. How many taxa did you remove?

2. Plot an abundance bar graph of the new gp object, and color the it in by Phylum. What are the most abundant phyla in each SampleType? Does this make sense with what you already know about these types of environments?
