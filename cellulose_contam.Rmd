...
Read in just the metaphlan2_total.csv file for now, and familiarize yourself with it.
...
I'm eager to read what you thought happened in community 3A. However, one of the thoughts I had was that *Asticcacaulis* represents contamination. *Asticcacaulis* is highly abundant in community 1B, but wasn't present in 3A until some time after trasnfer 50. These communities were maintained for multiple years by many people, so I don't think contamination is out of the question.
...
7) What are all the genomes you are comparing here? Why is there an *Asticcacaulis excentricus* genome in this analysis?

8) Compare all the 1B genomes to each other. How similar are they?

9) Compare the 1B genomes to the 3A genomes. How similar are they? You should google what similarity cutoffs are to consider bacteria the same "species." Do you think 1B contaminated 3A?
