...
The majority of my reads are from *Cellvibrio*, a known cellulose degrader. I think this finding makes sense, since we sequenced a cellulose degrading community. What are the most common genera of bacteria in your dataset? Do they match what your partner(s) got?



We will dig into the data we generated more on Wednesday. This is the end of part one. We will pick up with visualizing our data next lesson. For now, save your script and the R Workspace image so all your progress is saved.
